module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "DungUwU",
    description: "Công thức toán",
    commandCategory: "general",
    usages: "congthuc toan",
    cooldowns: 5,
    dependencies: {
        "request":"",
        "fs-extra":""
...
var msg = "";
    switch(handleReply.type) {
        ...
        case "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx": {
            switch(event.body) {
                case "1":  
            ...
            case "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx": {
            switch(event.body) {
        ...
        case "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx": {
            switch(event.body) {
...
module.exports.run = ({ event, api, args, client, utils }) => {
        switch(args[0]) {
            ...
            case "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx": {
            return api.sendMessage(
                "=== Lớp ===" +
                "\n» Mời bạn nhập lựa chọn «" +
                "\n\n1. Lớp 10." +
            ...
            default:
            return api.sendMessage("Sai cú pháp!", event.threadID, event.messageID); break;
        }
}