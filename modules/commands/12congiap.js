	...
	switch(event.body){
		case "1":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/ti.jpg`)
		...
		case "6":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/12congiap/ty.jpg`)
			}, event.threadID, event.messageID); 
			break;
		case "7":
			api.sendMessage({
