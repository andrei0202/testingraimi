module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "CatalizCS",
    description: "Truth list",
    commandCategory: "truth or dare!",
    cooldowns: 10
};
...
"If you could swap lives with someone in this room, who would it be?"
    ...
    return api.sendMessage(`Your truth: ${data[Math.floor(Math.random() * data.length)]}`, event.threadID, event.messageID);
}