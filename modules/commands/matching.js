...
var data = await Currencies.getData(event.senderID);
  ...
  var money = data.money
      if(money < 100) api.sendMessage("Bạn cần 100$ đô để xem tỉ lệ hợp nhau ?",event.threadID,event.messageID)
          else {
       ...
       var imglove = [];
        ...
        var msg = {body: `Matching (- 100$)\n\n❤️Tỉ lệ hợp đôi giữa ${namee} và ${name} là ${tle}% 🥰`, mentions: arraytag, attachment: imglove}
