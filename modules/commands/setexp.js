...
var mention = Object.keys(event.mentions)[0];
    ...
    var kong = 0;
			...
			if (args[0] !== 'me' && args[0] !== 'del' && args[0] !== 'uid' && Object.keys(event.mentions).length !== 1){return	api.sendMessage("Sai cú pháp!\n[setexp][user][exp]", event.threadID, event.messageID);}
    			if (args[0]=='me'){
...
var mention = Object.keys(event.mentions);
		...
		else return	api.sendMessage("Sai cú pháp!\n[setexp][del][me/tag]", event.threadID, event.messageID);
		}
			else if (Object.keys(event.mentions).length == 1) {
