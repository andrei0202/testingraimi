module.exports.config = {
  ...
  module.exports.handleEvent = async ({ event, api }) => {
    ...
    //trả lời
    var msg = {
      body: `Oke cho bạn 1 tô nè <3`,
      attachment: fs.createReadStream(__dirname + `/noprefix/bunbo.jpg`)
    }
    //body: `Chào ${name}, chúc bạn một ngày mới tốt lành ❤️`,
    // Gọi bot
    var arr = ["Thèm bún bò quá", "Thèm bún bò quớ", "Bún bò", "bún bò", "thèm bún bò quá"];
    arr.forEach(i=> {
