...
module.exports.run = async function({ api, event, args, Users, Threads, Currencies }) {
        ...
        api.changeNickname(`Người Yêu Của ${namee}`, event.threadID, id);
        var sex = (await Users.getData(id)).gender
        var gender = sex == 2 ? "Nam 🧑" : sex == 1 ? "Nữ 👩‍🦰" : "Bí Mật";
