...
module.exports.run = async ({ event, api, args }) => {
	...
	const { threadID, messageID, type, body, messageReply} = event;
	 ...
	 if (type == "message_reply") {
		 var data = messageReply.body;
		 if(content.indexOf('encode') == 0 || content.indexOf('en') == 0) {
		 ...
		 else if (content.indexOf('decode') == 0 || content.indexOf('de') == 0) {
			text = data.toLowerCase();
        ...
        else if(type2 == 'endcode' || type2 == "en") {
