...
module.exports.run = async({
  ...
  if (value > 7) return api.sendMessage(`Biết cầu vồng nhiu màu không chọn dữ vậy ?`, event.threadID, event.messageID);
  ...
  return;}
  catch(e){return api.sendMessage(`Thử rainbow lại đi!`, event.threadID, event.messageID);}
}